#!/usr/bin/env bash
# AxiaPanel Remote Agent Installer
# Usage: curl -sSL https://panel.example.com/install-agent.sh | sudo bash -s -- \
#   --panel-url https://panel.example.com \
#   --token <agent_token> \
#   --server-id <server_uuid>
#
# This installs ONLY the AxiaPanel agent binary (no database, no API, no frontend).
...
echo "======================================"
echo "  AxiaPanel Agent Installer (Remote)"
echo "======================================"
echo ""
...
echo ""
echo "======================================"
echo "  AxiaPanel Agent installed!"
echo "======================================"
echo ""
