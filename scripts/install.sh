...
# Usage: curl -sL https://raw.githubusercontent.com/Dev-Encrypted/AxiaPanel/main/scripts/install.sh | bash
#
# Modes:
...
if [ -d "$INSTALL_DIR/.git" ]; then
    ...
    rm -rf "$INSTALL_DIR"
    git clone --depth 1 -b "$VERSION" https://github.com/Dev-Encrypted/AxiaPanel.git "$INSTALL_DIR"
fi
