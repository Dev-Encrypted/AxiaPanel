...
pub async fn send_verification_email(
    ...
    let body = format!(
        r#"<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p style="color: #6b7280; font-size: 14px;">Ou copie este link: {link}</p>
            <p style="color: #9ca3af; font-size: 12px;">Este link expira em 24 horas. Se você não criou uma conta, ignore este e-mail.</p>
        </div>"#
    );
...
pub async fn send_reset_email(
    ...
    let body = format!(
        r#"<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p style="color: #6b7280; font-size: 14px;">Ou copie este link: {link}</p>
            <p style="color: #9ca3af; font-size: 12px;">Este link expira em 1 hora. Se você não solicitou isso, ignore este e-mail.</p>
        </div>"#
    );
