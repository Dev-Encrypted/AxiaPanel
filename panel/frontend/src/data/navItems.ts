...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/notifications", label: "Notificações", iconName: "notifications" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/container-policies", label: "Políticas de Container", iconName: "servers", adminOnly: true },
      { to: "/integrations", label: "Integrações", iconName: "extensions", adminOnly: true },
      { to: "/secrets", label: "Secrets", iconName: "secrets", adminOnly: true },
      { to: "/security", label: "Segurança", iconName: "security", adminOnly: true },
      { to: "/system", label: "Sistema", iconName: "servers", adminOnly: true },
      { to: "/telemetry", label: "Telemetria", iconName: "monitoring", adminOnly: true },
