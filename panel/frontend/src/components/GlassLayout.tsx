      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="flex-1 text-left whitespace-nowrap overflow-hidden">Buscar...</span>
              ...
              <div className="flex items-center justify-between px-3 mt-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] text-dark-400">
                    {apiHealthy === null ? "Verificando..." : apiHealthy ? "Conectado" : "Desconectado"}
                  </span>
                </div>
                <div className="flex items-center gap-1">
                <Link to="/notifications" className="relative p-1.5 text-dark-400 hover:text-dark-200 transition-colors rounded shrink-0" title="Notificações" aria-label="Notificações">
