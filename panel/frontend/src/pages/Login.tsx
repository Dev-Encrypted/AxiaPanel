      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-dark-200 text-sm mt-1">
            {twoFaToken ? "Digite seu código 2FA" : "Entre no seu painel"}
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="bg-dark-800 rounded-lg border border-dark-600 p-6 space-y-4 elevation-2">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label htmlFor="login-password" className="block text-sm font-medium text-dark-100">Senha</label>
        ...
        {branding.oauthProviders.length > 0 && !twoFaToken && (
          <div className="mt-4">
            <div className="flex items-center gap-3 my-4">
              <div className="flex-1 h-px bg-dark-600" />
              <span className="text-xs text-dark-400 uppercase">ou continue com</span>
              <div className="flex-1 h-px bg-dark-600" />
            </div>
