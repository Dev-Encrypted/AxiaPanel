    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <p className="text-dark-300 text-sm font-mono">
          Verifica seu servidor em busca de erros de configuração, problemas de recursos e questões de segurança.
        </p>
        <button
      ...
      {report && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
          ...
          >
            ...
            <div className="text-sm text-dark-300">Críticos</div>
          </button>
          <button
          ...
          >
            ...
            <div className="text-sm text-dark-300">Avisos</div>
          </button>
          <button
      ...
      {!report && !loading && (
        <div className="text-center py-20 text-dark-300">
          ...
          <p className="text-lg">Clique em "Executar Verificação" para checar a saúde do servidor</p>
        </div>
      )}
      ...
      {report && report.summary.total === 0 && (
        <div className="text-center py-16 bg-dark-900 rounded-lg border border-dark-500">
          ...
          <p className="text-lg text-rust-400 font-medium">Tudo OK</p>
          <p className="text-dark-300 mt-1">Nenhum problema detectado no seu servidor.</p>
        </div>
      )}
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    {finding.fix_available && finding.fix_id && !result?.ok && (
                      ...
                      >
                        {fixing === finding.id ? "Corrigindo..." : "Corrigir"}
                      </button>
                    )}
                  </div>
                </div>
